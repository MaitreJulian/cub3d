...
/*   Updated: 2025/11/19 14:15:28 by gcauchy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_data	*d)
{
	if (d->map->tab[(int)d->cam->posx]
		[(int)(d->cam->posy + d->cam->diry * (d->cam->move_speed + 0.1))] != '1')
		d->cam->posy += d->cam->diry * d->cam->move_speed;
	if (d->map->tab[(int)(d->cam->posx + d->cam->dirx * (d->cam->move_speed + 0.1))]
		[(int)d->cam->posy] != '1')
...
{
	if (d->map->tab[(int)d->cam->posx]
		[(int)(d->cam->posy + d->cam->dirx * (d->cam->move_speed + 0.1))] != '1')
		d->cam->posy += d->cam->dirx * d->cam->move_speed;
	if (d->map->tab[(int)(d->cam->posx - d->cam->diry * (d->cam->move_speed + 0.1))]
		[(int)d->cam->posy] != '1')
